...
<?php
    ...
    if ($mau=='edit') 
    {
       ...
       // $pass   = $_POST['password'];
        ...
        if ($cek==1) 
        {
            ...
            ";
            pindahHalaman("akun-profile&mod=profil&tuj=profile");
        } 
        else 
        {
            ...
            */
            ...
            <script>
                ...
                swal('Data Usaha Tersimpan!', 'Anda bisa melihat di menu Profile!', 'success')
                    .then((value)=> {
                        window.location='?hal=akun-profile&mod=akun-bisnis&tuj=profile';
                    })
            </script>
            ";
        } 
    ...
    elseif ($mau=="preneur_edit") 
    {
        ...
        ";
            ...
            $folderFoto = "foto/bisnismember/$fotolama";
    ...
    elseif ($mau=='dibaca') 
    {
        ...
        if ($cek==1) 
        {
           /* echo
            ...
            ";*/
            pindahHalaman("akun-transaksi&tuj=profile");
        } 
        else 
        {
            echo
