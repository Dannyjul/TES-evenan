...
<div class="container container-card-non-res">
    <div class="container-card">
        ...
        echo
        "
              <h1 class='display-heavy status-member'>$namaPaket</h1>        
            ";
            ...
            foreach ($result as $a) {
                ...
                "
                  <div class='card-course'>
                    <div class='row-1'>
                        $gambar
                        <a class='btn btn-mulai subheader-heavy' href='?hal=course-info&k=$idkel&p=$idpaket' >Mulai Kelas</a>
                    </div>
                    <div class='card-body row-2'>
                        <h2 class='headline-heavy'>$nama</h2>
                        <p class='small-heavy'>$hit Pelajaran</p>
                        <h3 class='subheader-heavy'>Description</h3>
                        <p class='caption-light'>$desk</p>
                    </div>
                  </div>
...
<div class="container container-card-res">
    <class="container-card">
        <?php
            ...
            echo
            "
                <h1 class='body-heavy status-member'>$namaPaket</h1>    
            ";
        ?>
        ...
        if ($hitung == 0) {
            ...
            foreach ($result as $a) {
                ...
                "
                <div class='col'>
                    <div class='card card-course-res'>
                    $gambar
                    <div class='card-body'>
