...
<form class="container-akun-bisnis-detail-non-res" action="?hal=akun-respon&mode=preneur_edit" method="post" enctype="multipart/form-data">
...
<form class="container-akun-bisnis-detail-res" action="?hal=akun-respon&mode=preneur_edit" method="post" enctype="multipart/form-data">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <label for="">Deskripsi Singkat Bisnis Anda</label>
            <input class="input-data-profile desc-bisnis" name="deskripsi" placeholder="Deskripsi Singkat" value = "<?php echo $deskrip; ?>" required>
            ...
            <label for="alamat-bisnis">Alamat Bisnis <font color="crimson" size='3'>*</font></label>
            <input name="alamat" required id="alamat-bisnis" class="input-data-profile alamat" type="text" value=<?php echo $alamatBis; ?>>
