...
--
-- Host: localhost
-- Generation Time: Apr 11, 2021 at 07:05 PM
...
(17, 'Belajar Berbisnis dari Nol', '2021-04-11', '<p>nsaknska skaskakhsa nskaksa.</p>\r\n', 'Event-20210411094408.jpg', 308211325, 'Bandung', 'Jl. Cikutra', '2021-04-11 14:43:00', 100000, 15, 'POSTING');
...
(30, 'GEM 3 - Visi Misi Bisnis', '<p><strong>Keterangan:</strong></p>\r\n\r\n<p>akakjajja hahAK ahhakakhkhak ahkhAKha ahkahk.&nbsp;akakjajja hahAK ahhakakhkhak ahkhAKha ahkahk.&nbsp;akakjajja hahAK ahhakakhkhak ahkhAKha ahkahk.&nbsp;akakjajja hahAK ahhakakhkhak ahkhAKha ahkahk.&nbsp;akakjajja hahAK ahhakakhkhak ahkhAKha ahkahk.&nbsp;akakjajja hahAK ahhakakhkhak ahkhAKha ahkahk.</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>Untuk <a href=\"https://drive.google.com/file/d/1t4gnTqQsW-IqLOcbmFMh-znuTWbEgCnN/view?usp=sharing\"><strong>download</strong></a>.</p>\r\n', 'kursus-20210314103647.jpg', 2, 5, 3),
...
(38, 'Bisnis Keren', '<p>aksakska saksakhs sakhsak sam sabskahsa hsahksa ahshahska.</p>\r\n', 'kursus-20210408095930.jpg', 6, 7, 6);
...
(10, 3, 3, 'Wow', 308210836, '2021-04-11', 'Belum dibaca'),
(11, 3, 5, 'Memuaskan juga, kalo lebih bagus lagi....banyakin lagi kelasnya....hehehe', 404210559, '2021-04-11', 'Belum dibaca'),
(12, 3, 3, 'ye....', 404210559, '2021-04-11', 'Belum dibaca');
...
(65, 'Mengikuti Event Event Baru', '1212121', 'Bank Danamon', 'Danny Julian', '2021-03-24', NULL, 16, 324211100, 100000, 'Expired', 'Belum dibaca', 'Sudah dibaca', 'Struk_event-20210324110404.jpg', '2021-03-24'),
...
(68, 'Upgrade Membership ke-Self Employee', '909090', 'Bank Bukopin', 'Omat Amit', '2021-04-04', 6, NULL, 324211100, 2000000, 'Ok', 'Sudah dibaca', 'Belum dibaca', 'Struk_paketMember-20210404054149.jpg', '2022-04-04');
...
(404210559, 'Tomi Lao', 'Tom Tom', '1990-08-29', 'Laki-laki', '079898989989', 'tommilao@gmail.com', '123456', 'Kosong', 'Member', 'Aktif', 'on');
...
--
ALTER TABLE `event`
  MODIFY `id_event` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `paket_kelas`
  MODIFY `id_paketkelas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `user_status`
  MODIFY `id_userstats` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
