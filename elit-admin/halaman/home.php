             ...
             <div class="card shadow mb-4">
                 ...
                 <div class="card-body">
                     ...
                     <?php
                        ...
                        $komenan = $isi->eksekusiSQl("SELECT *FROM rating_kelas
                                                        INNER JOIN kelas ON kelas.id_kelas=rating_kelas.id_kelas
                                                        INNER JOIN user ON user.id_user = rating_kelas.id_user
                                                        ORDER BY rating_kelas.id_rating DESC");
                        $hitungKomenan= $isi->hitungData($komenan);
                        ...
                        {
                            $no=1;
                            foreach($komenan as $kom)
                            {
                               $kelasKomen = $kom['nama_kelas'];
                               $userKomen  = $kom['nama_user'];
                               $fotoUser   = $kom['foto'];
                               $komentar   = $kom['komentar'];
                               $tglKomen   = $kom['tgl_komen'];


                               $waktuKomen = tglBalik($tglKomen);


                               $fotoKomtator = "../foto/user/$fotoUser";
                                ...
                                else 
                                {
                                   // $tujuan = "../foto/paket/$foto";
                                    $gambar = 
                                    "   
                                    <img src='$fotoKomtator' width='100' height='100'>
                                    ";
                                ...
                                echo
                                "
                                <a href='#' class='card mb-3 kartu' style='width: 100%; font-size:12px;'>
                                    <div class='row g-0'>
                                    <div class='col-md-5' style='padding:20px;'>
                                        <center>
                                            $gambar
                                            <small class='text-secondary'>$userKomen</small>
                                        </center>
                                    </div>
                                    <div class='col-md-7'>
                                        <div class='card-body'>
                                        <p class='card-title'>Komentar pada <span class='text-primary'>$kelasKomen</span></p>
                                            $komentar <br><br>
                                            <small class='text-secondary'>pada $waktuKomen</small>
                                        </div>
                                    </div>
                                    </div>
                                </a>
