 <?php
    $idp = @$_GET['idp'];
    $perintah = $isi->eksekusiSQl("SELECT *FROM user_status
                INNER JOIN user ON user.id_user=user_status.id_user
                INNER JOIN paket_member ON paket_member.id_paket=user_status.id_paket
                WHERE user_status.id_paket='$idp'");

    $carPaket = $isi->eksekusiSQL("SELECT *FROM paket_member WHERE id_paket='$idp'");

    foreach ($carPaket as $p) 
    {
       $pkt = $p['nama_paket'];
    }
 ?>
 ...
 <div class="container-fluid teks12">
     ...
     <div class="d-sm-flex align-items-center justify-content-between mb-4">
         <h1 class="h3 mb-0 text-gray-800">Data Member Paket <?php echo $pkt; ?></h1>
         ...
         <div class="col-xl-9 col-lg-8">
             ...
             <div class="card shadow mb-4">
                 ...
                 <div class="card-body">
                     ...
                     <a class='btn btn-success' href='?hal=member-data'>Tampilkan Semua</a>
                     <br><br>
         ...
         <div class="card shadow mb-4">
                 ...
                 <div class="card-body">
                     ...
                     <?php
                        ...
                        $membernya = $isi->eksekusiSQl("SELECT *FROM user");
